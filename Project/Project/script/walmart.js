...
function filterByDept(){
    document.getElementById("allFiltersWin").style.display = "none";
    if(document.querySelector("input[name='allDepartmentsFilter']:checked")){
        detectChangeOfDept();
    }else{
        detectChangeOfRating();
    }
}
...
function sortProducts(val){
    if(val === "low"){
        sortBy('price');
        document.getElementById("sortDropDown").style.display = "none";
        document.getElementById("spanSortChev").setAttribute("src", "image/chevron-down-icon.svg");
        document.getElementById("spanSortText2").innerHTML="Price Low";
        // document.getElementById("bestSellerSort").style.display="none";
    }else if(val ==="high"){
        sortBy('price', true);
        document.getElementById("sortDropDown").style.display = "none";
        document.getElementById("spanSortChev").setAttribute("src", "image/chevron-down-icon.svg");
        document.getElementById("spanSortText2").innerHTML="Price High";
    }else if(val ==="match"){
        document.getElementById("spanSortText2").innerHTML="Best Match";
        document.getElementById("sortDropDown").style.display = "none";
        document.getElementById("spanSortChev").setAttribute("src", "image/chevron-down-icon.svg");
    }else if(val ==="seller"){
        document.getElementById("spanSortText2").innerHTML="Best Seller";
        document.getElementById("sortDropDown").style.display = "none";
        document.getElementById("spanSortChev").setAttribute("src", "image/chevron-down-icon.svg");
    }
